          ...
          <div class="row">
            <div class="col-lg-3 col-md-6">
              <div class="single-service">
                <img class="img-fluid" src="<?=base_url()?>assets/estilos/img/lunares.jpg" alt="">
            ...
            <div class="col-lg-3 col-md-6">
              <div class="single-service">
                <img class="img-fluid" src="<?=base_url()?>assets/estilos/img/peeling.jpg" alt="">
            ...
            <div class="col-lg-3 col-md-6">
              <div class="single-service">
                <img class="img-fluid" src="<?=base_url()?>assets/estilos/img/rejuvenecimiento.jpg" alt="">
            ...
            <div class="col-lg-3 col-md-6">
              <div class="single-service">
                <img class="img-fluid" src="<?=base_url()?>assets/estilos/img/uña.jpg" alt="">
               ...
               <div class="col-lg-3 col-md-6">
              <div class="single-service">
                <img class="img-fluid" src="<?=base_url()?>assets/estilos/img/meso.jpg" alt="">
             ...
             <div class="col-lg-3 col-md-6">
              <div class="single-service">
                <img class="img-fluid" src="<?=base_url()?>assets/estilos/img/manchas.jpg" alt="">
              ...
              <div class="col-lg-3 col-md-6">
              <div class="single-service">
                <img class="img-fluid" src="<?=base_url()?>assets/estilos/img/Rosacea.jpg" alt="">
             ...
             <div class="col-lg-3 col-md-6">
              <div class="single-service">
                <img class="img-fluid" src="<?=base_url()?>assets/estilos/img/acne.jpg" alt="">
        ...
        <div class="container">
          <div class="row align-items-center justify-content-end">
            <div class="col-lg-6 no-padding home-about-right">
              <h2 class="text-white">
               Medicina estética en Corrientes <br>
              </h2>
            </br>
              <p class="text-white">
               En Santillán Teresita Dermatóloga, tenemos a su disposición nuestro servicio de medicina estética, porque reconocernos lo importante que es para nuestros usuarios verse y sentirse bien. Estamos esperando su visita.
              </p>
