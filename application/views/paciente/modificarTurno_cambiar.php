...
<a href="<?php echo base_url()?>registrado/CI_confirmarturno/confirmarTurno_modificar/<?php echo $listaTurno->id_hora;?>/<?php echo $fecha;?> " class="btn btn-success btn-check"><span class="fa fa-check"></span></a>
                                                </div>  
                                            </td>
                                       </tr>
