                ...
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="form-group">
                               ...
                               <form action="<?php echo base_url();?>registrado/Modificar_turno/buscarHoras" method="post">
                                <div class="col-md-3">
...
<a href="<?php echo base_url()?>registrado/CI_confirmarturno/confirmarTurno_modificado/<?php echo $listaTurno->id_hora;?>/<?php echo $fecha;?>/<?php echo $idturno;?>" class="btn btn-success btn-check"><span class="fa fa-check"></span></a>
                                                </div>  
                                            </td>
                                       </tr>
...
<a href="<?php echo base_url()?>registrado/CI_confirmarturno/confirmarTurno_modificado/<?php echo $listaTurno1->id_hora;?>/<?php echo $fecha;?>/<?php echo $idturno;?> " class="btn btn-success btn-check"><span class="fa fa-check"></span></a>
                                                </div>  
                                            </td>
                                       </tr>
